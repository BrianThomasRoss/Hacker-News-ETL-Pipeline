...
try:
    ...
    db = client.twitter_election_sentiment
    print("Connected successfully!!!")
except:
    print("Could not connect to MongoDB")

# connect kafka consumer to desired kafka topic
consumer = KafkaConsumer('electionSentimentTwitterStream',
...
for msg in consumer:
    ...
    try:
        twitter_rec = {'text': text, 'senti_val': senti_val, 'subjectivity': subjectivity,
                       'creation_datetime': creation_datetime, 'username': username, 'location': location,
